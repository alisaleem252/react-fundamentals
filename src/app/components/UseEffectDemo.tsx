 ...
 * 
 *kisi event ke baad action perform karta hai.🌐 API se data fetch karna
 *⏰ Timer ya interval chalana
 *👂 Event listener add karna (jaise window resize)
...
export function UseEffectDemo() {
  ...
  }, []);//Empty Array []Sirf ek baar chalega jab component first time render hoga.
